...
const FileSys_1 = require("./FileSys");
...
class TemplateGenerator {
    constructor() {
        this.fileSys = FileSys_1.FileSys.getFileSystem();
    ...
    generateClient(filePath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.fileSys.createFile(file, template);
        });
    }
    generateDirectories(basePath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.fileSys.createDirectory(utils);
            this.logger.success('Created Utilities Directory');
            yield this.fileSys.createDirectory(structures);
            this.logger.success('Created Structures Directory');
            if (this.language === 'typescript') {
                yield this.fileSys.createDirectory(client);
                this.logger.success('Created Client Directory');
            }
            yield this.fileSys.createDirectory(commands);
            this.logger.success('Created Commands Directory');
            yield this.fileSys.createDirectory(events);
            this.logger.success('Created Events Directory');
            yield this.fileSys.createDirectory(test);
            this.logger.success('Created TestCommand Directory');
            yield this.fileSys.createDirectory(ready);
            this.logger.success('Created ReadyEvent Directory');
            yield this.fileSys.createDirectory(message);
    ...
    generateCommand(categoryPath, name, category) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const exists = yield this.fileSys.exists(filePath);
            if (!exists) {
                const isJs = this.language === 'javascript';
                const template = isJs
    ...
    generateEvents(events, eventsDir) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const event of events) {
                ...
                if (!exists) {
                    yield this.fileSys.createFile(filePath, template);
                }
            }
        });
    }
